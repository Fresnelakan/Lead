...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Map<String, String>> onboardingData = [
    {
      ...
      "subtitle":
          "Organisez votre emploi du temps facilement et optimisez votre quotidien pour plus d'efficacité.",
    },
    {
      "image": "assets/onboard2.png",
      "title": "Saisie simple et personnalisée",
      "subtitle":
          "Créez votre emploi du temps en quelques clics, ajoutez vos activités spécifiques et visualisez votre semaine.",
    },
    {
      "image": "assets/onboard3.png",
      "title": "Ne manquez plus rien d'important",
      "subtitle":
          "Visualisez clairement vos engagements et restez organisé pour atteindre vos objectifs",
    },
    {
      "image": "assets/onboard4.png",
      "title": "Prêt à organiser votre temps ?",
      "subtitle":
          "Inscrivez-vous et découvrez une nouvelle façon de gérer votre emploi du temps.",
    },
  ];
  ...
  void _finishOnboarding() async {
    ...
    await prefs.setBool(
      'onboarding_seen',
      true,
    ); // Correction: 'onboarding_seen' au lieu de 'onboarding_done'
